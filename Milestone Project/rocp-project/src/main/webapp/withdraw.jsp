...
<!-- 	Just some stuff you need -->
	...
	%>
		...
		<form action="accounts\withdrawConfirm" method="post" class="form-horizontal">
		  ...
		  <div class="form-group">
		   ...
		   <div class="form-group">
		    ...
		    <div class="col-sm-5">
		      <input type="number" step ="0.01" class="form-control" id="withdrawAmount" name="withdrawAmount" placeholder="0.00" required="required" />
		    </div>
		  </div>
		  
		  <div class="form-group">
		    <div class="col-sm-offset-4 col-sm-1">
		      <button type="submit" class="btn btn-info">Withdraw Money</button>
		    </div>
		  </div>
